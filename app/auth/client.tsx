...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create Your JiraBolt Account",
        description: "Start your first project in seconds.",
        button: "Sign Up",
        helper: (
          <span>
    ...
    return {
      id: "signin",
      title: "Welcome back to JiraBolt",
      description: "Sign in to manage your projects and track issues.",
      button: "Sign In",
      helper: (
        <span>
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Fast, intuitive issue tracking built for today’s teams.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure authentication, beautiful interface, and a seamless onboarding flow—all with JiraBolt.
              </p>
            </div>
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center text-sm mt-2">{content.helper}</div>
            </CardContent>
          </Card>
        </div>
      </section>
